...
\begin{enumerate}[leftmargin=*, label=\textbf{C\arabic*.}]
  ...
  \item \textbf{Empirical Latency Characterisation.} We provide reproducible
    ...
    benchmarks for future research (\cref{sec:results}).
...
\Cref{sec:litreview} surveys related work in collaborative development
environments, real-time synchronisation protocols, and AI-assisted
programming, comparing \echoray{} against 2025--2026 state-of-the-art systems.
...
topology.
\Cref{sec:methodology} provides the complete technical methodology: formal
data-structure definitions, mathematical proofs, and information-flow diagrams.
...
\Cref{sec:implementation} discusses implementation decisions, the full
technology stack with pinned dependency versions, and hardware requirements.
\Cref{sec:results} reports empirical latency and throughput measurements
compared against published benchmarks and explains the code-level optimisations
driving performance advantages.
\Cref{sec:conclusion} concludes with an impact summary and three future-work
directions grounded in current code-level limitations.
